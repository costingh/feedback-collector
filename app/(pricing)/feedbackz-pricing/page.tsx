	...
	return (
		...
		>
			...
			<Button
				...
				} hover:bg-indigo-600 hover:text-white transition border-[1px] border-indigo-600 flex items-center justify-center gap-2`}
	...
	return (
		<div className="min-h-screen bg-white text-center py-16">
			...
			<p className="text-lg text-gray-500 mb-8">
				Experience Feedbackz firsthand. No credit card needed to start.
			</p>

			<Link href="/sign-up">
				<Button className="inline bg-indigo-600 text-white transition border-[1px] border-indigo-600">
			...
			<Tabs defaultValue="yearly">
				<TabsList className="bg-gray-100 rounded-full inline-flex p-1 mb-12">
					<TabsTrigger
						value="yearly"
						className="w-48 rounded-full px-6 py-2 text-base font-medium"
					>
						Pay yearly{" "}
			...
			{/* <div className="mt-12">
				<a
					href="#"
					className="text-indigo-600 text-lg font-medium hover:underline inline-flex items-center space-x-1"
				>
			...
			<div className="mt-12 max-w-4xl mx-auto space-y-6 px-4 sm:px-6">
