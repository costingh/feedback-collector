...
export const MegaphoneLoud20RegularIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg 
...
export const DashboardChartIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg 
    ...
    {...props}
  >
    <g xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="1.5"><rect width="18.5" height="18.5" x="2.75" y="2.75" rx="6"/><path stroke-linecap="round" stroke-linejoin="round" d="m7 15l2.45-3.26a1 1 0 0 1 1.33-.25L13.17 13a1 1 0 0 0 1.37-.29L17 9"/></g>
  </svg>
);
...
export const PersonFeedback48RegularIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg 
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="currentColor" d="M30.27 25c-.24 0-.49-.04-.73-.12A2.211 2.211 0 0 1 28 22.75v-2.81c-2.26-.36-4-2.33-4-4.69v-6.5C24 6.13 26.13 4 28.75 4h11.5C42.87 4 45 6.13 45 8.75v6.5c0 2.62-2.13 4.75-4.75 4.75h-5.12l-3.08 4.1c-.44.58-1.09.9-1.78.9ZM28.75 6.5c-1.24 0-2.25 1.01-2.25 2.25v6.5c0 1.24 1.01 2.25 2.25 2.25h1.75V22l3.38-4.5h6.38c1.24 0 2.25-1.01 2.25-2.25v-6.5c0-1.24-1.01-2.25-2.25-2.25H28.75ZM16 27.5c-4.14 0-7.5-3.36-7.5-7.5c0-4.14 3.36-7.5 7.5-7.5c4.14 0 7.5 3.36 7.5 7.5c0 4.14-3.36 7.5-7.5 7.5ZM16 15c-2.76 0-5 2.24-5 5s2.24 5 5 5s5-2.24 5-5s-2.24-5-5-5ZM3 34.79c0 .09.15 9.21 13 9.21s13-9.12 13-9.21v-1.04c0-2.07-1.68-3.75-3.75-3.75H6.75C4.68 30 3 31.68 3 33.75v1.04Zm2.5-1.04c0-.69.56-1.25 1.25-1.25h18.5c.69 0 1.25.56 1.25 1.25v1.03c0 .27-.22 6.72-10.5 6.72S5.5 35.05 5.5 34.79v-1.04Z"/>
  </svg>
);


export const Widget6BrokenIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    width={size} 
...
export const EditCreateIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
...
export const ZapIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg 
    ...
    {...props}
  >
    <path xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8.628 12.674H8.17c-1.484 0-2.225 0-2.542-.49c-.316-.489-.015-1.17.588-2.533l1.812-4.098c.548-1.239.822-1.859 1.353-2.206S10.586 3 11.935 3h2.09c1.638 0 2.458 0 2.767.535c.309.536-.098 1.25-.91 2.681l-1.073 1.886c-.404.711-.606 1.066-.603 1.358c.003.378.205.726.53.917c.25.147.657.147 1.471.147c1.03 0 1.545 0 1.813.178c.349.232.531.646.467 1.061c-.049.32-.395.703-1.088 1.469l-5.535 6.12c-1.087 1.203-1.63 1.804-1.996 1.613c-.365-.19-.19-.983.16-2.569l.688-3.106c.267-1.208.4-1.812.08-2.214c-.322-.402-.937-.402-2.168-.402" color="currentColor"/>
  </svg>
);

export const AskQuestionIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 26 26" 
    width={size} 
...
export const Card2BrokenIcon = ({ size = 24, color = 'currentColor', ...props }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    width={size} 
...
export const MENU_ITEMS = (
...
): { title: string; href?: string; icon?: React.ReactNode }[] => [
	{
		...
		icon: <DashboardChartIcon className="w-6 h-6" />,
	},
	{
		title: "COLLECT",
	},
	{
		...
		icon: <MegaphoneLoud20RegularIcon className="w-6 h-6" />,
	},
	{
		title: "Import Testimonials",
		href: `/dashboard/${workspaceId}/import-testimonials`,
		icon: <Tabs20RegularIcon className="w-6 h-6" />,
	},
	{
		title: "ORGANIZE",
	},
	...
	},
	{
		...
		icon: <PersonFeedback48RegularIcon className="w-6 h-6" />,
	},
	{
		title: "DESIGN",
	},
	{
		...
		icon: <Widget6BrokenIcon className="w-6 h-6" />,
	},
	{
		title: "Creator",
		href: `/dashboard/${workspaceId}/creator`,
		icon: <EditCreateIcon className="w-6 h-6" />,
	},
	{
		title: "INTEGRATE",
	},
	...
	},
	{
		...
		icon: <AskQuestionIcon className="w-6 h-6" />,
	},
	{
		title: "CUSTOMIZE",
	},
	...
	},
	{
		...
		icon: <Card2BrokenIcon className="w-6 h-6" />,
	},
	// {
	// 	title: "Settings",
