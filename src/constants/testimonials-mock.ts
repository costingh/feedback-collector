export const testimonialsMock = [
	{
		avatar: "/images/mock-avatar-1.png",
		name: "Alice Johnson",
	...
	{
		avatar: "/images/mock-avatar-2.png",
		name: "Michael Brown",
		jobTitle: "CTO, Software Development",
		stars: 4,
		message:
			"Great features, but the support could be faster. Overall, it's been a positive experience and well worth the price.",
	},
	{
		avatar: "/images/mock-avatar-3.png",
		name: "Sophia Martinez",
		jobTitle: "HR Manager, Human Resources",
		stars: 5,
		message:
	...
	{
		avatar: "/images/mock-avatar-4.png",
		name: "James Lee",
		jobTitle: "Marketing Manager, Branding",
		stars: 3,
		message:
	...
	},
	{
		avatar: "/images/mock-avatar-4.png",
		name: "Liam Harris",
		jobTitle: "IT Manager, Information Technology",
		stars: 2,
		message:
