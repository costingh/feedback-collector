    ...
    return (
        <>
                        ...
                        >
                            <div className="avatar flex flex-col items-start justify-start text-left max-w-full w-[350px]">
                                ...
                                <span className="text-gray-600 text-[13px] font-[400]">
                                    {t?.jobTitle !== 'NOT GIVEN' ? t?.jobTitle : ''}
                                </span>
                            </div>
                            <div className="w-full text-left">
                                ...
                                <div className="my-3 text-[15px] text-gray-700 font-normal max-w-[700px]">
                                    {t?.message.length > _MAX_CHARACTERS_TO_SHOW && !expandedMessages.has(t.id)
                                    ...
                                    {t?.message.length > _MAX_CHARACTERS_TO_SHOW && (
                                        ...
                                        >
                                            {expandedMessages.has(t.id) ? "See less" : "See more"}
                                        </span>
                                    )}
                                </div>
            ...
            <div className="flex items-center justify-between border-t border-gray-200 pt-[20px]">
                <div className="flex items-center gap-4">
                    <div>
                        <button
                            ...
                            className={`px-4 py-2 text-white rounded-md transition ${canImportSelectedTestimonials()
                ...
                <div className="flex items-center gap-4">
                {testimonials.length && <p>Found a total of {testimonials.length} testimonials</p>}
