...
function ColorPicker({
	...
	const getColorAsString = (colorAsObject: {
		r: number
		g: number
		b: number
		a: number
					...
					<div className="flex items-center gap-2 justify-between my-3 px-4">
						<div className="flex flex-col items-center justify-center gap-2">
							<input
								type="text"
								value={color.r}
								className="w-[30px] border-[1px] border-gray-200 rounded-[4px] px-[10px] py-[4px] text-gray-800 font-light text-[13px] outline-purple-600 outline-1"
							/>
