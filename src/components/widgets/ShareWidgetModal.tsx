...
export function ShareWidgetModal({
	...
	const renderTabContent = () => {
		...
		return (
			<div className="w-full">
				<h1 className="text-gray-800 font-semibold text-sm">
					How would you like to embed your widget?
				</h1>
				<p className="text-gray-600 font-normal text-xs">
					You can embed your widget as an inline embed fot the moment.
				</p>
				<div className="flex items-center space-x-2 mt-2">
					{renderEmbedOption(1)}
					{/* {renderEmbedOption(2)} */}
				</div>
				<h1 className="text-gray-800 font-semibold text-sm mt-3">
					Your Code Snippet
				</h1>
				<p className="text-gray-600 font-normal text-xs">
					To embed your testimonials, paste the following code snippet
	...
	return (
		<Dialog
			open={isOpened || undefined}
			onOpenChange={handleClose || undefined}
		>
