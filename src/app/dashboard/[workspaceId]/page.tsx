		...
		<div className="space-y-4 py-[40px] px-[20px]">
			...
			<div className="grid gap-4 sm:grid-cols-12 md:grid-cols-9 lg:grid-cols-8">
				<div className="col-span-12 md:col-span-6 lg:col-span-5">
					<AreaGraph
						chartData={dashboardData?.data?.visitsEvolutionChart}
					/>
				</div>

				<div className="col-span-12 md:col-span-3 lg:col-span-3">
					<PieChart
						data={dashboardData.data.formsSplitByStateChart}
					/>
				</div>
			</div>
			...
			<div className="grid gap-4 sm:grid-cols-12 md:grid-cols-9">
				...
				<div className="col-span-12 md:col-span-6 lg:col-span-3">
					<TopCountriesList
						topCountries={dashboardData.data.topCountriesData}
					/>
				</div>

				<div className="col-span-12 md:col-span-6 lg:col-span-3">
					<TopEngagingFormsList
						forms={dashboardData.data.topEngagingForms}
					/>
				</div>
			</div>
		</div>
