export const KpisSection = () => {
    const kpis = [
        ...
        { value: "+120h", text: "Save Over 120 Hours on Manual Outreach and Chasing Feedback" },
        { value: "100%", text: "Customizable Widgets That Match Your Brand Seamlessly" },
        { value: "+35%", text: "Boost Conversion Rates by Showcasing Authentic Social Proof" },
    ];
                ...
                <div className="grid w-full grid-cols-2 gap-6 md:grid-cols-4">
                    {kpis.map((kpi, index) => (
                        ...
                        >
                            ...
                            <div className="text-center text-white text-[14px]">{kpi.text}</div>
                        </div>
                    ))}
                </div>
            </div>
