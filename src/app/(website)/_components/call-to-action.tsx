...
const CallToAction = () => {
	return (
		<section className="-mb-20 mt-6 px-6">
				...
				<div className="order-1 flex flex-col gap-6 sm:order-2">
					...
					<ul className="flex flex-col">
						<li className="flex items-center">
							<GreenCheckIcon />
							<span className="ml-3 text-lg text-gray-DEFAULT-400">
								Create testimonial collector forms with a few
								clicks
							</span>
						</li>
						<li className="flex items-center">
							<GreenCheckIcon />
							<span className="ml-3 text-lg text-gray-DEFAULT-400">
								Curate and display testimonials on your website
							</span>
						</li>
						<li className="flex items-center">
							<GreenCheckIcon />
							<span className="ml-3 text-lg text-gray-DEFAULT-400">
								Increase your conversion rate by 3x
							</span>
						</li>
					</ul>
					<div className="w-full max-w-[500px] flex flex-col gap-4 items-center justify-center">
						<HeroButton variant="md" text="Start Now For FREE" />
