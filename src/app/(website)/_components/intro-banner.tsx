			...
			<div className="card-bg mt-20 z-10 flex w-full flex-col px-6 py-10 backdrop-blur-md lg:px-20 lg:py-20">
				<div className="mx-auto max-w-3xl px-4 text-center">
					...
					<p className="mt-4 text-lg text-white lg:text-xl">
						Feedbackz.co automates testimonial collection using
						proven CRO strategies to boost conversions and cut
						costs.
					</p>
				</div>
				...
				<div className="mt-16 grid gap-10 md:grid-cols-2">
					<div className="order-2 lg:order-1 flex flex-col space-y-6">
						...
						<p className="text-gray-400 md:text-lg">
							Automate the collection, display, and impact of
							customer feedback — and unlock scalable social proof
							that sells.
						</p>
						<ul className="flex flex-col gap-3">
							{benefits.map((point, i) => (
								<li key={i} className="flex items-start">
									<GreenCheckIcon />
									<span className="ml-3 text-white md:text-gray-400">
										{point}
									</span>
								</li>
							))}
