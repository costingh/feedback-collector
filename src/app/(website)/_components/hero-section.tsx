				...
				<div className="flex flex-wrap gap-4 flex-col items-center justify-center">
					<div className="max-w-3xl text-center relative">
						<div className="flex flex-col items-center justify-center">
							...
							{/* prettier-ignore */}
							{/* @ts-ignore */}
							<feedbackz-form data-form-id="BZVUq9HK" data-widget-type="chat-style-floading-widget"></feedbackz-form>
					...
					<div className="flex items-center gap-10 mt-4">
						...
						<a href="https://saashub.net" target="_blank" rel="noopener">
							<img src="https://saashub.net/api/badges/simple" alt="SaasHub - Product Launch Platform" width="160" height="60" className="rounded-full" />
						</a>
