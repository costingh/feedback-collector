...
const features = [
	...
	},
	{
		...
		feedbackzIntegration: {
			...
			widget2:
				'<feedbackz-widget data-widget-id="kqwFSO3"></feedbackz-widget>',
			widget3:
		...
		<Container className="my-[100px]">
			<div className="mx-auto flex max-w-5xl flex-col gap-6 px-4 mb-[60px]">
				...
				<div className="mx-auto max-w-[350px] text-center text-lg text-white md:max-w-3xl lg:text-xl">
					Create beautifully branded, customizable testimonial forms.
					Share them with your users, collect authentic feedback, and
					publish it using widgets or testimonial walls — directly on
					your landing page, product site, or SaaS platform.
				</div>
			</div>
